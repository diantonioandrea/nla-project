...
Moreover, \cref{fig:stokes} demonstrates that the \textit{k-sGMRES} algorithm is capable of handling larger matrices, such as the \textbf{stokes} matrix, where \lstinline{MATLAB}'s \textit{GMRES} algorithm fails to converge due to memory and time limitations.
...
\begin{figure}[!ht]
    \begin{subfigure}[b]{0.49\textwidth}
        \begin{tikzpicture}[scale=.9]
            ...
            \addplot[color=\accentcolor, mark=*] coordinates {(100,1.037e-03) (250,3.628e-04) (500,1.236e-04) (1000,4.016e-05)};
    ...
    \begin{subfigure}[b]{0.49\textwidth}
        \begin{tikzpicture}[scale=.9]
            ...
            \addplot[color=\accentcolor, mark=*] coordinates {(100,113070) (250,281376) (500,568571)(1000,1147874)};
            \legend{\textit{k-sGMRES} (\lstinline{C++23})}
            \end{loglogaxis}
        \end{tikzpicture}
    \end{subfigure}
