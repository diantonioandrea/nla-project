...
\begin{figure}[!ht]
    \begin{subfigure}[b]{0.49\textwidth}
        \begin{tikzpicture}[scale=.9]
            ...
            \addplot[color=black, mark=*] coordinates {(100,4.50e-06) (250,2.9e-07) (500,2.8e-08) (1000,1.6e-09) (2500,9e-13)};
    ...
    \begin{subfigure}[b]{0.49\textwidth}
        \begin{tikzpicture}[scale=.9]
            ...
            \addplot[color=black, mark=*] coordinates {(100,9937) (250,54045) (500,209483) (1000,792628) (2500,4887066)};
            \legend{\textit{k-sGMRES} (\lstinline{C++23}),\textit{GMRES} (\lstinline{MATLAB})}
            \end{loglogaxis}
        \end{tikzpicture}
    \end{subfigure}
